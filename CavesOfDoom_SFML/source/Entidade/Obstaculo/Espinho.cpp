...
namespace Entidades {
    ...
    namespace Obstaculo {
        ...
        void Espinho::inicializarAnimacao() {
            textura = pGrafico->carregarTextura("imagens/Obstaculos/Espinho.png");
        ...
        void Espinho::colisao(Entidade* outraEntidade, sf::Vector2f ds) {
            if (outraEntidade->getID() == IDs::IDs::jogador) {
                Personagens::Player::Jogador* pJogador = dynamic_cast<Personagens::Player::Jogador*>(outraEntidade);
