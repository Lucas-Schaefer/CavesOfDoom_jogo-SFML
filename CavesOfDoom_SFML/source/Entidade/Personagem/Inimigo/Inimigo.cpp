...
namespace Entidades {
    ...
    namespace Personagens {
        ...
        namespace Inimigos {
            ...
            Inimigo::Inimigo(const sf::Vector2f pos, const sf::Vector2f tam, Player::Jogador* jogador, const IDs::IDs ID, const float tempoMorrer, const float tempoAtacar, const float experiencia) :
