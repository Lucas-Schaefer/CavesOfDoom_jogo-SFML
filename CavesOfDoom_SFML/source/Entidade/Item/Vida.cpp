...
namespace Entidades {
    ...
    namespace Item {
        ...
        void Vida::inicializarAnimacao() {
            animacao.addAnimacao("imagens/Itens/vida.png", "VIDA", 3, 0.20f, sf::Vector2f(1.0f, 1.0f));
        }
        ...
        void Vida::colisao(Entidade* outraEntidade, sf::Vector2f ds) {
            ...
            if (ID_Outro == IDs::IDs::jogador) {
                Personagens::Player::Jogador* jogador = dynamic_cast<Personagens::Player::Jogador*>(outraEntidade);
